...
class TransactionServiceTest {
    ...
    @Test
    @DisplayName("해지 계좌는 잔액을 사용할 수 없다.")
    ...
    @Test
    @DisplayName("거래금액인 잔액보다 크면 사용할 수 없다")
    void useBalance_exceedAmount_() {
        //given
        AccountUser user = AccountUser.builder()
                .name("Pobi").build();
        user.setId(12L);
    ...
    @Test
    @DisplayName("실패 transaction 저장 성공")
    ...
    void CancelBalance_CancelMustFlly() {
        //given
        AccountUser user = AccountUser.builder()
                .name("Pobi").build();
        user.setId(12L);
